...
import { ArrowsRightLeftIcon, ArrowUturnLeftIcon, BackwardIcon, ForwardIcon, PauseIcon, PlayIcon, SpeakerWaveIcon } from '@heroicons/react/20/solid'
    ...
    return (
        <div className='h-24 bg-gradient-to-b from-black to-gray-900 grid grid-cols-3 text-xs md:text-base px-2 md:px-8'>
            ...
            <div className='flex justify-evenly items-center'>
                ...
                <BackwardIcon className='icon-playback' onClick={handlePlayPause.bind(this, 'previous')} />
                {
                    isPlaying ? <PauseIcon className='icon-playback' onClick={handlePlayPause} /> : <PlayIcon className='icon-playback' onClick={handlePlayPause} />
                }
                <ForwardIcon className='icon-playback' onClick={handlePlayPause.bind(this, 'next')} />
            ...
            <div className='flex justify-end items-center pr-5 space-x-3 md:space-x-4'>
                ...
                <input type="range" min={0} max={100} className='w-20 md:w-auto' value={volume} onChange={handleVolumeChange} />
            </div>
        </div>
    )
}
